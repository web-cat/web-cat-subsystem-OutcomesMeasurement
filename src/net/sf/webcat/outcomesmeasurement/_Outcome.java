    ...
    extends er.extensions.eof.ERXGenericRecord
{
    ...
    public static final ERXKey<net.sf.webcat.outcomesmeasurement.Outcome> isSupportedBy =
        new ERXKey<net.sf.webcat.outcomesmeasurement.Outcome>(IS_SUPPORTED_BY_KEY);
    public static final String OUTCOME_SETS_KEY = BASE_PREFIX_DOT + "outcomeSets";
    public static final ERXKey<net.sf.webcat.outcomesmeasurement.OutcomeSet> outcomeSets =
        new ERXKey<net.sf.webcat.outcomesmeasurement.OutcomeSet>(OUTCOME_SETS_KEY);
    public static final String SUPPORTS_KEY = BASE_PREFIX_DOT + "supports";
    public static final ERXKey<net.sf.webcat.outcomesmeasurement.Outcome> supports =
        new ERXKey<net.sf.webcat.outcomesmeasurement.Outcome>(SUPPORTS_KEY);
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.outcomesmeasurement.Outcome> isSupportedBy()
    {
     ...
     */
    public void setIsSupportedBy( NSMutableArray<net.sf.webcat.outcomesmeasurement.Outcome>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     */
    public void addToIsSupportedBy( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.outcomesmeasurement.Outcome> array =
            (NSMutableArray<net.sf.webcat.outcomesmeasurement.Outcome>)isSupportedBy();
        willChange();
     ...
     */
    public void removeFromIsSupportedBy( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToIsSupportedByRelationship( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromIsSupportedByRelationship( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
     ...
     */
    public net.sf.webcat.outcomesmeasurement.Outcome createIsSupportedByRelationship()
    {
        if (log.isDebugEnabled())
        {
     ...
     */
    public void deleteIsSupportedByRelationship( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllIsSupportedByRelationships()
    {
        ...
        for (net.sf.webcat.outcomesmeasurement.Outcome object : isSupportedBy())
        {
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.outcomesmeasurement.OutcomeSet> outcomeSets()
    {
     ...
     * @param value The new set of entities to relate to
     */
    public void setOutcomeSets( NSMutableArray<net.sf.webcat.outcomesmeasurement.OutcomeSet>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToOutcomeSets( net.sf.webcat.outcomesmeasurement.OutcomeSet value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.outcomesmeasurement.OutcomeSet> array =
            (NSMutableArray<net.sf.webcat.outcomesmeasurement.OutcomeSet>)outcomeSets();
        willChange();
        array.addObject( value );
    }
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromOutcomeSets( net.sf.webcat.outcomesmeasurement.OutcomeSet value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToOutcomeSetsRelationship( net.sf.webcat.outcomesmeasurement.OutcomeSet value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromOutcomeSetsRelationship( net.sf.webcat.outcomesmeasurement.OutcomeSet value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @return The new entity
     */
    public net.sf.webcat.outcomesmeasurement.OutcomeSet createOutcomeSetsRelationship()
    {
        if (log.isDebugEnabled())
        {
        ...
        return (net.sf.webcat.outcomesmeasurement.OutcomeSet)eoObject;
    }
     ...
     * @param value The entity to remove from the relationship and then delete
     */
    public void deleteOutcomeSetsRelationship( net.sf.webcat.outcomesmeasurement.OutcomeSet value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllOutcomeSetsRelationships()
    {
        ...
        for (net.sf.webcat.outcomesmeasurement.OutcomeSet object : outcomeSets())
        {
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.outcomesmeasurement.Outcome> supports()
    {
     ...
     * @param value The new set of entities to relate to
     */
    public void setSupports( NSMutableArray<net.sf.webcat.outcomesmeasurement.Outcome>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToSupports( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.outcomesmeasurement.Outcome> array =
            (NSMutableArray<net.sf.webcat.outcomesmeasurement.Outcome>)supports();
        willChange();
        array.addObject( value );
    }
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromSupports( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToSupportsRelationship( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromSupportsRelationship( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @return The new entity
     */
    public net.sf.webcat.outcomesmeasurement.Outcome createSupportsRelationship()
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship and then delete
     */
    public void deleteSupportsRelationship( net.sf.webcat.outcomesmeasurement.Outcome value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllSupportsRelationships()
    {
        ...
        for (net.sf.webcat.outcomesmeasurement.Outcome object : supports())
        {
