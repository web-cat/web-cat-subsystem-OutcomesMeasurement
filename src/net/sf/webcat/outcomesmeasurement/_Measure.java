    ...
    extends er.extensions.eof.ERXGenericRecord
{
    ...
    public static final ERXKey<net.sf.webcat.outcomesmeasurement.MeasureOfOffering> measureOfOfferings =
        new ERXKey<net.sf.webcat.outcomesmeasurement.MeasureOfOffering>(MEASURE_OF_OFFERINGS_KEY);
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.outcomesmeasurement.MeasureOfOffering> measureOfOfferings()
    {
     ...
     * @param value The new set of entities to relate to
     */
    public void setMeasureOfOfferings( NSMutableArray<net.sf.webcat.outcomesmeasurement.MeasureOfOffering>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToMeasureOfOfferings( net.sf.webcat.outcomesmeasurement.MeasureOfOffering value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.outcomesmeasurement.MeasureOfOffering> array =
            (NSMutableArray<net.sf.webcat.outcomesmeasurement.MeasureOfOffering>)measureOfOfferings();
        willChange();
        array.addObject( value );
    }
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromMeasureOfOfferings( net.sf.webcat.outcomesmeasurement.MeasureOfOffering value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToMeasureOfOfferingsRelationship( net.sf.webcat.outcomesmeasurement.MeasureOfOffering value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromMeasureOfOfferingsRelationship( net.sf.webcat.outcomesmeasurement.MeasureOfOffering value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @return The new entity
     */
    public net.sf.webcat.outcomesmeasurement.MeasureOfOffering createMeasureOfOfferingsRelationship()
    {
        if (log.isDebugEnabled())
        {
        ...
        return (net.sf.webcat.outcomesmeasurement.MeasureOfOffering)eoObject;
    }
     ...
     * @param value The entity to remove from the relationship and then delete
     */
    public void deleteMeasureOfOfferingsRelationship( net.sf.webcat.outcomesmeasurement.MeasureOfOffering value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllMeasureOfOfferingsRelationships()
    {
        ...
        for (net.sf.webcat.outcomesmeasurement.MeasureOfOffering object : measureOfOfferings())
        {
