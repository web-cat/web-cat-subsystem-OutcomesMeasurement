    ...
    extends net.sf.webcat.outcomesmeasurement.Outcome
{
    ...
    public static ProgramOutcome create(
        ...
        net.sf.webcat.outcomesmeasurement.Program programValue
        )
    {
    ...
    public static final ERXKey<net.sf.webcat.outcomesmeasurement.Program> program =
        new ERXKey<net.sf.webcat.outcomesmeasurement.Program>(PROGRAM_KEY);
     ...
     */
    public net.sf.webcat.outcomesmeasurement.Program program()
    {
        return (net.sf.webcat.outcomesmeasurement.Program)storedValueForKey( "program" );
    }
     ...
     */
    public void setProgram( net.sf.webcat.outcomesmeasurement.Program value )
    {
    ...
    public void setProgramRelationship(
        net.sf.webcat.outcomesmeasurement.Program value )
    {
        if (log.isDebugEnabled())
        {
        ...
        if ( value == null )
        {
            net.sf.webcat.outcomesmeasurement.Program object = program();
            if ( object != null )
